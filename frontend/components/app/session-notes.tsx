  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-1.5 bg-muted/30 rounded-full overflow-hidden">
        <MotionDiv
          className="absolute inset-y-0 left-0 bg-gradient-to-r from-blue-500 via-cyan-500 to-indigo-500 rounded-full"
          initial={{ width: 0 }}
      ...
      <AnimatePresence>
        {progress === 3 && (
          <MotionDiv
            ...
            className="mt-2 p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-500/20"
          >
            <p className="text-xs text-blue-600 dark:text-blue-400 text-center font-semibold flex items-center justify-center gap-2">
              <span className="text-base">🎉</span>
              Session complete!
            </p>
          </MotionDiv>
